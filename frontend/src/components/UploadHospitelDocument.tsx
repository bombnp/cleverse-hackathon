...
export const UploadHospitelDocument = ({
  ...
  const onFileUpload = (event: any) => {
    ...
    if (selectedFile !== undefined && selectedFile.type === 'application/pdf') {
      ...
      axios
        .post(`${API_URL}/upload/document`, formData)
  ...
  return (
    <div>
      ...
      />
      <button
        className="w-24 h-8 bg-white border rounded-2xl px-2"
        onClick={() => (fileInput as any).current.focus()}
      >
        <label
